      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('dashboard') }}" class="app-brand-link">
              <span class="app-brand-logo demo">
                ...
                <img src="{{ asset('img/logo1.jpg') }}" alt="" width="50px" height="50px">
                  <defs>
                    <path
              ...
              <span class="app-brand-text demo uppercase fw-bolder ms-2 "><h5>Tk Daarul Rahman</h5> </span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
              <a href="{{ route('Admin.datapendaftar') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Data Pendaftar</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('tambahgalery') }}" class="menu-link">
                    <div data-i18n="Account">Galery</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('tambahlogo') }}" class="menu-link">
                    <div data-i18n="Account">Logo</div>
                  </a>
                </li>
              </ul>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('template/assets/img/avatars/user.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
