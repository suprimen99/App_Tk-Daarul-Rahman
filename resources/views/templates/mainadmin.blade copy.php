...
>
  ...
  <!-- Layouts -->
  <li class="menu-item {{ Request::is('Admin/datapendaftar') ? 'active' : '' }}">
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      <li class="menu-item {{ Request::is('tambahparalax') ? 'active' : '' }}">
        <a href="{{ route('tambahparalax') }}" class="menu-link">
          <div data-i18n="Account">Paralax</div>
        </a>
      </li>
      <li class="menu-item {{ Request::is('tambahgalery') ? 'active' : '' }}">
